    ...
    <footer className="bg-green-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">AgriMarket Match</h3>
            <p className="text-gray-300">
              Connecting small-scale farmers with local buyers to create a more efficient and transparent agricultural marketplace.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/market-trends" className="text-gray-300 hover:text-white transition-colors">Market Trends</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:info@agrimarket.com" className="text-gray-300 hover:text-white transition-colors">info@agrimarket.com</a>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-8 pt-6 border-t border-green-700">
          <p className="text-center text-gray-300">
            &copy; {new Date().getFullYear()} AgriMarket Match. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
