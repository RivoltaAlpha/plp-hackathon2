    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {marketplaceItems.map((item) => (
          <div key={item.id} className="bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-200 text-sm mb-2">{item.seller}</p>
              <p className="text-gray-200 text-xs mb-3 flex items-center gap-1">
              ...
              <div className="flex justify-between items-center mb-4">
                <div>
                  <span className="text-2xl font-bold text-gray-200">Ksh {item.price}</span>
                  <span className="text-gray-200 text-sm ml-1">{item.unit}</span>
                </div>
      ...
      <div className="text-center">
        <button className="bg-white text-gray-900 px-8 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200">
          Load More Products
        </button>
      </div>
    </div>
